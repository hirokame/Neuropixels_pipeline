function [ydemod, cfg, figs] = quickdemod_LP1(y,fs,frqs,cfg_)
...
cfg.downsample_fs       = 30; % 250219 to be equal to MJ's rig
cfg.downsample          = round(fs/cfg.downsample_fs);
cfg.plot                = 0;
cfg.frqs__Hz            = frqs;
