...
draw_step1(Ch405,Ch465,Ch560,detrend_sec,fs,Ts,portion,blowup_win_s,mag_factor,style)
title('All sensor 1')
...
% Ch465 = ydemod465_2';
% Ch560 = ydemod560_2';
% draw_steps(Ch405,Ch465,Ch560,detrend_sec,fs,Ts,filter_down,h2,fac,Smoothing_on,Smoothing_Value,highpass_yn,portion,N,...
%                     cut_percent,blowup_win_s,mag_factor,detrend_before_Delta,detrend_linearFit,Iakovos_base,style,data,box,fig_save_dir)
%% differen
